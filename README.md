...
This if my first cyber security project that I worked on. I mainly did it to learn how SIEMs work, how to forward, analyze, and respond to logs alongside with understanding the attackers mindset as well as how attacks are done in a real world scenario. Although it seemed like a simple "Attack and Analyze Log" project, it turned out to be a lot more complicated as you will see in the "Steps" section. I learned a lot more than just Analyzing and attacking but rather configurating, troubleshooting, detection engineering, mapping attacks to MITRE ATT&CK, OWSAP and more.
